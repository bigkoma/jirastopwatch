namespace StopWatchTest
{
    ...
    public class JiraClientTest
    {
        ...
        public void GetIssueSummary_OnFailure_It_Returns_Empty_String()
        {
            ...
            Assert.Throws<RequestDeniedException>(() => jiraClient.GetIssueSummary("DG-42", false));
        }
        ...
        {
            jiraApiRequesterMock.Setup(m => m.DoAuthenticatedRequestForTransition(It.IsAny<RestRequest>()));
        ...
        {
            jiraApiRequesterMock.Setup(m => m.DoAuthenticatedRequestForTransition(It.IsAny<RestRequest>())).Throws<RequestDeniedException>();
